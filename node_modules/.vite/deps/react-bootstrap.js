import {
  ...
  useWaitForDOMRef,
  useWindow
} from "./chunk-RZNFJ425.js";
import {
  CarouselCaption_default,
  CarouselItem_default,
  Carousel_default,
  useTimeout
} from "./chunk-6U2534L7.js";
import {
  ENTERING,
  EXITING,
  ...
  transitionEnd,
  useWillUnmount
} from "./chunk-WY54JXAC.js";
import {
  Button_default as Button_default2
} from "./chunk-K52BN2VY.js";
import {
  Col_default,
  ...
  require_warning,
  useCol
} from "./chunk-E4GWJTSN.js";
import {
  forEach,
  map
} from "./chunk-FS4NRP6O.js";
import {
  require_prop_types
...
import {
  Button_default
} from "./chunk-YJD6OTGX.js";
import {
  require_react_dom
} from "./chunk-MMW4JUSU.js";
import {
  Container_default
} from "./chunk-HZ7LQPLA.js";
import {
  DEFAULT_BREAKPOINTS,
...
var Modal = React56.forwardRef(({
  ...
  const renderBackdrop = (0, import_react21.useCallback)((backdropProps) => (0, import_jsx_runtime55.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React57.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames47.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime56.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime56.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
var Overlay2 = React64.forwardRef(({
  ...
  const [firstRenderedState, setFirstRenderedState] = (0, import_react25.useState)(null);
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime67.jsxs)(import_jsx_runtime66.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react26.cloneElement)(children, triggerProps), (0, import_jsx_runtime65.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react28.useContext)(TabContext_default);
  if (!context4)
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react29.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react29.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
var ToastFade = React83.forwardRef((props, ref) => (0, import_jsx_runtime88.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React85.forwardRef(({
  ...
  const context4 = (0, import_react30.useContext)(ToastContext_default);
...
var Toast = React87.forwardRef(({
  ...
  const delayRef = (0, import_react31.useRef)(delay);
  const onCloseRef = (0, import_react31.useRef)(onClose);
  ...
  const autohideFunc = (0, import_react31.useCallback)(() => {
    if (autohideToast) {
  ...
  const toastContext = (0, import_react31.useMemo)(() => ({
    onClose
  }), [onClose]);
