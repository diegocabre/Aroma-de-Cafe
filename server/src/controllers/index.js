...
const {addProducto,getDataIntoCar}= require('./CarritoController/index')

module.exports = {getData, getDataById,getDataFilter,login,userRegistrer,addProducto,getDataIntoCar}